...
export default function useForm(initial = {}) {
  ...
  function validateSubmit(formName) {
    ...
    if (formName === 'request-reset') newInputErrors = {email: validateEmail(inputs.email)}
    if (formName === 'reset-password') newInputErrors = {password: validatePassword(inputs.password)}
