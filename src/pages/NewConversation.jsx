...
export default function NewConversation() {
  ...
  function addRecipient(user) {
    ...
    const alreadyRecipient = recipients.find(
      (recipient) => user._id === recipient._id
    );
    if (!alreadyRecipient) {
  ...
  async function handleCreateConversation() {
    ...
    try {
      ...
      activateToast(
        ...
        "Could not create your conversation.",
        "error"
      );
    }
  }
  ...
  return (
    <>
      <ToastComponent />
      <PageHeader user={user} pageTitle="New Conversation" />
      <SearchContacts addRecipient={addRecipient} />
      <NewConversationInfo
